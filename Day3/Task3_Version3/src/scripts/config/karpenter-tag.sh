...
EKS_APP_NODE_GROUP_NAME="apdev-app-node"
PUBLIC_A_SN_NAME="apdev-public-a"
PUBLIC_C_SN_NAME="apdev-public-c"
PRIVATE_A_SN_NAME="apdev-private-a"
PRIVATE_C_SN_NAME="apdev-private-c"
EKS_APP_NODE_SECURITY_GROUP_NAME="apdev-eks-app-node-sg"
...
EKS_NODE_GROUP_SECURITY_GROUP_ID=$(aws ec2 describe-security-groups --query "SecurityGroups[?GroupName=='$EKS_APP_NODE_SECURITY_GROUP_NAME'].GroupId" --output text --region $REGION_CODE)

aws ec2 create-tags --resources $EKS_NODE_GROUP_SECURITY_GROUP_ID --tags Key=karpenter.sh/discovery,Value=$EKS_APP_NODE_GROUP_NAME
